CREATE TABLE [dbo].[Personalized_Status] (
    ...
    CONSTRAINT [FK_dbo.Personalized_Status_dbo.Product_Service] FOREIGN KEY ([Code_ID], [Entrepreneur_Email], [Category_ID]) REFERENCES [dbo].[Product_Service] ([Code_ID], [Entrepreneur_Email], [Category_ID]),
